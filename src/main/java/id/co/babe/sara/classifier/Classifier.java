package id.co.babe.sara.classifier;
...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
	...
	/**
	 * Initial capacity of feature dictionaries. Should be quite big - features
	 * will quickly surpass the categories.
	 */
	...
	/**
	 * A dictionary mapping features to occurrences number in each category.
	 */
	public Dictionary<K, Dictionary<T, Integer>> featureCountPerCategory;

	/**
	 * A dictionary mapping features to their number of occurrences.
	 */
	public Dictionary<T, Integer> totalFeatureCount;

	/**
	 * A dictionary mapping categories to their number of occurrences.
	 */
	public Dictionary<K, Integer> totalCategoryCount;
	...
	/**
	 * Sets the memory's capacity. If new value < old value, memory will be
	...
	public void incrementFeature(T feature, K category) {
		...
		// New category - initialize category - features map
		if (features == null) {
		...
		// Current count of feature in category
		Integer count = features.get(feature);

		// Increase category-occurrence of feature
		if (count == null) {
		...
		// Increase total occurrence of feature
	 ...
	 * Equal to tell classifier, that this category has occurred once more.
	 *
	 * @param category The category - to increase count.
	 */
	 ...
	 * probability.
	 *
	 * @see id.co.babe.sara.classifier.Classifier#featureProbability(Object, Object)
	 * @see id.co.babe.sara.classifier.Classifier#featureWeighedAverage(Object,
